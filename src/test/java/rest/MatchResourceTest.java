...
public class MatchResourceTest
{
    ...
    @Test
    public void testGetMatchesByPlayerID() throws Exception {
        login("user", "test123");
        given()
                .contentType("application/json")
                .header("x-Access-token", securityToken)
                .get("/matches/{id}/play", p1.getId())
                .then()
                .assertThat()
                .statusCode(HttpStatus.OK_200.getStatusCode())
                .body("judge", hasItem(m1.getJudge()));
    ...
    @Test
    public void testGetMatchesByLocationId() throws Exception {
        login("user", "test123");
        given()
                .contentType("application/json")
                .header("x-Access-token", securityToken)
                .get("/matches/{id}/location", l1.getId())
                .then()
                .assertThat()
                .statusCode(HttpStatus.OK_200.getStatusCode())
                .body("judge", hasItem(m1.getJudge()));
